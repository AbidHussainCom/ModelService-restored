...
//  ModelServices
//
//  Created by Le Abid on 18/02/2014.
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell.imageView setImageWithURL:[NSURL URLWithString:item.urlString]];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [MHGallerySharedManager sharedManager].ivForPresentingAndDismissingMHGallery = [[tableView cellForRowAtIndexPath:indexPath] imageView];
    ...
    [self presentMHGalleryWithItems:galleryData
                     ...
                     finishCallback:^(UINavigationController *galleryNavMH, NSInteger pageIndex, UIImage *image) {
                         ...
                         dispatch_async(dispatch_get_main_queue(), ^{
                             UIImageView *iv = [[self.tableView cellForRowAtIndexPath:newIndex] imageView];
